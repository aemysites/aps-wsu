...
## Environments
- Preview: https://main--aps-wsu--aemysites.aem.page/
- Live: https://main--aps-wsu--aemysites.aem.live/
- Block Library: https://main--aps-wsu--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `aps-wsu` directory in your favorite IDE and start coding :)
